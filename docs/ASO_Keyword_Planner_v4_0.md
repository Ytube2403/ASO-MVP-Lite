...
## 25. Cập nhật v3.5 — Các thay đổi phổ quát hệ thống (Universal Pipeline Updates)
...
- mac dinh --max-workers 2 de tranh gui qua nhieu request GTX cung luc
