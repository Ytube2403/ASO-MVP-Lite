...
APP_CONFIG = {
    ...
    # =========================================================================
    "app_id": "com.funvideo.face.filter.swap.changer.effect",      # Package ID của ứng dụng
    "app_name": "FunVid: Funny Face Filters",                      # Tên ứng dụng đầy đủ hiển thị trên Store
    "category": "Funny Face Filters",                              # Danh mục ứng dụng
    "category_slug": "face_filter",                                # Slug dùng cho đường dẫn
    "market": "US_EN",                                             # Mã thị trường mặc định
    "platform_mode": "google_play",                                # Nền tảng: 'google_play'
    "semantic_mode": "face_filter",
    ...
    "intent_core_terms": [
        ...
        "face filter", "face filters", "funny face filter", "funny face filters", 
        "face swap", "face changer", "face distortion", "funny filter", "funny filters",
        "weird face filters", "camera effects", "silly camera effects",
        "unicorn head filter", "unicorn filter", "tiktok face filters", 
        "tiktok funny face filters", "funny face viral challenge", "funny face challenge",
        "animals face", "animal face test", "what animal do i look like", 
        "what animal do i look like filter", "animal look alike", "animal look alike filter"
    ],

    "feature_terms": [
        # Các từ khóa mô tả tính năng / chức năng cụ thể của ứng dụng
        "animal morph", "animal morphing", "horse morph", "platypus face", "camel face", 
        "rat face", "dragon head", "husky head", "silly selfie", "funny selfies", 
        "funny videos", "silly reaction", "prank filter", "face swap online", "distorted face",
        "brown horse morph", "horse morph filter", "platypus face filter", "camel face filter",
        "rat face filter", "dragon head filter", "husky head filter", "animal morph filter",
        "animal head filters", "funny animal filters", "animal face shape", "animal face type", 
        "cat face shape", "fox face shape", "deer face shape", "bunny face shape", 
        "puppy face shape", "filter bạn giống con gì", "filter khuôn mặt động vật", 
        "filter test khuôn mặt động vật"
    ],

    "style_terms": [
        # Các từ khóa mô tả phong cách, giao diện, IP hoặc theme thẩm mỹ
        "funny", "silly", "weird", "playful", "entertaining", "crazy", "hilarious", 
        "exaggerated", "silly face", "aesthetic", "comic"
    ],

    "visual_terms": [
        # Các từ khóa mô tả giao diện phụ trợ, hiệu ứng hình ảnh
        "selfie", "selfies", "video", "videos", "photo", "photos", "clip", "clips", "camera"
    ],
    ...
    # =========================================================================
    "competitor_brands": [
        # Tên các đối thủ cạnh tranh nổi tiếng
        "faceapp", "reface", "facelab", "face28", "vysionapps", "sjh infotech", "snapfilter", "funnycamera", "crazypictures"
    ],

    "noise_terms": [
        # Các từ khóa chung chung, generic quá rộng
        "app", "apps", "free", "download", "android", "for android", "new", "best", "top"
    ],

    "typo_blacklist": [
        # Các từ khóa gõ sai chính tả phổ biến hoặc vô nghĩa
        "filte", "swape", "chagner", "funny face filte", "funvid", "fun video"
    ],

    "irrelevant_intent_terms": [
        # Từ khóa thuộc danh mục khác, không liên quan
        "widget", "widgets", "launcher", "theme launcher", "game", "games", "calculator",
        "wallpaper", "wallpapers", "ringtone", "ringtones",
        "bug", "bugs", "bugzz", "bugzzz", "spider", "spiders", "insect", "insects", "lip", "lips",
        "age", "aged", "aging", "old", "older", "ar"
    ],
    ...
    "risky_platform_terms": ["iphone", "ios", "ipad", "apple", "android", "tiktok", "snapchat", "instagram", "time warp scan"],
    ...
    "balanced_weights": {
        ...
        "DifficultyN": 0.10,      # Trọng số điểm Difficulty
        "KEIN": 0.10,             # Trọng số điểm KEI
        "RelevancyScore": 0.25,   # Trọng số điểm liên quan
