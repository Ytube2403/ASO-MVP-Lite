...
echo     git clone https://github.com/Ytube2403/ASO-MVP-Lite.git
echo.
echo   Buoc 5: Cai dat Python packages:
echo     cd ASO-MVP-Lite
...
if /i "%ready%"=="y" (
    ...
    git clone https://github.com/Ytube2403/ASO-MVP-Lite.git "%destdir%\ASO-MVP-Lite"
    if %ERRORLEVEL% EQU 0 (
        echo.
        echo  ✅  Clone thanh cong! Du an nam tai: %destdir%\ASO-MVP-Lite
    ) else (
        echo.
